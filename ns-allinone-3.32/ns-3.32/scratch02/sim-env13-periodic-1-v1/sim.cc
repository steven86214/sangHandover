...
void setUpBuildings()
{
    ...
    gridBuildingAllocator->SetAttribute("LengthX", DoubleValue(100));
    gridBuildingAllocator->SetAttribute("LengthY", DoubleValue(50));
    ...
    gridBuildingAllocator->SetAttribute("MinX", DoubleValue(1904));
    gridBuildingAllocator->SetAttribute("MinY", DoubleValue(1770));
